...
limits and integrated integrated branch lengths.
*/


public class iHKYNoBoundMatrix extends QMatrix {
    private double pR;
    private double pY;
    private double b;
    private double c;
    ...
    public iHKYNoBoundMatrix(double[] inV, double[] inPi) {
	...
	if( npi[3] < 0.0 )
	    return null;
	return new iHKYNoBoundMatrix(p,npi);
    }
    
    public static void main(String args[]) {
	double[] p  = { 10 };
	double[] pi = { 0.25, 0.25, 0.25, 0.25 };
	QMatrix q = new iHKYNoBoundMatrix(p,pi);
